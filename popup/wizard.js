...
function showUserAccount(auth)
{
        ...
        $.get('http://imgur.com/user/' + auth.url + '/submitted/newest.json' , function(data){
                if(data.data.length != 0)
                {
                        ...
                        $("#submission1").prepend('<img class="gallery-img" src="https://i.imgur.com/' + data.data[0].hash  + 'b.jpg">');
                ...
                if(data.data.length > 1)
                {
                        ...
                        $("#submission2").prepend('<img class="gallery-img" src="https://i.imgur.com/' + data.data[1].hash  + 'b.jpg">');
